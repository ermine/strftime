...
(* OASIS_START *)
(* DO NOT EDIT (digest: 51a9f6a9cf0b5f400ea4c2ba7ec49a61) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "C strftime-like function";
          description = None;
          categories = [];
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://github.com/ermine/strftime.git";
                      src_repo_browser =
                        Some "https://github.com/ermine/strftime";
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "\014‹Š6ò¡e—Ž\025<¡cµbP";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
